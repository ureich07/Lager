...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.btRefresh)
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.btGn)
        self.toolBar.addAction(self.btGe)
        self.toolBar.addAction(self.btRo)
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.actionSuchen)
        self.toolBar.addAction(self.btBedarf)
        self.toolBar.addSeparator()
...
#if QT_CONFIG(tooltip)
        self.actionSuchen.setToolTip(QCoreApplication.translate("MainWindow", u"Suchen", None))
#endif // QT_CONFIG(tooltip)
        self.btBedarf.setText(QCoreApplication.translate("MainWindow", u"T\u00e4glicher Bedarf", None))
